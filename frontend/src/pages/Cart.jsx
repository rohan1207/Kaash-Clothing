  ...
  return (
    <div className="bg-stone-50 min-h-screen pt-28 pb-16 font-serif">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-thin text-stone-800 text-center mb-4">
            Shopping Cart
          </h1>
        ...
        {cartItems.length === 0 ? (
          ...
          >
            ...
            <Link
              to="/shop"
              className="bg-stone-800 text-white font-sans font-medium py-3 px-8 tracking-wider hover:bg-stone-700 transition-colors duration-300"
            >
              CONTINUE SHOPPING
            </Link>
          </motion.div>
